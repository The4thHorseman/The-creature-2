...
float   ballX             = 100 ,  ballY             = 100; //ændrede til float
float   eyeLeftRelativeX  = 5   ,  eyeLeftRelativeY  = 5; //ændrede til float
...
void draw() {                         
  float ballwalk =  sin(ballX*0.5)*10;  //svingning på +10 til -10 pixels, fjernede dobbelt skråstreg foran float
